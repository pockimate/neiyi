<template>
  <footer class="bg-gradient-to-br from-pink-50 to-purple-50 border-t border-pink-200 py-16 px-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
        ...
        <div>
          <div class="flex items-center space-x-2 mb-4">
            ...
            <span class="font-display text-xl font-semibold text-primary">Intimate Elegance</span>
          </div>
          <p class="text-slate-600 text-sm leading-relaxed">Where elegance meets desire. Premium luxury lingerie for the modern woman.</p>
        </div>
        ...
        <!-- Connect -->
        <div>
          <h3 class="font-display text-lg font-semibold mb-4 text-textPrimary">Connect</h3>
          ...
          <p class="text-sm text-slate-600">Follow us for exclusive offers and updates</p>
        </div>
      </div>
