    ...
    <section class="py-12 px-4">
      <div class="max-w-4xl mx-auto space-y-8">
        ...
        <div class="glass-card rounded-2xl p-8 border border-pink-200">
          ...
          <div class="space-y-4">
            <div>
              <h3 class="font-semibold text-textPrimary mb-2">Personal Information</h3>
              <p class="text-slate-600 mb-2">When you make a purchase, we collect:</p>
            ...
            <div>
              <h3 class="font-semibold text-textPrimary mb-2">Automatically Collected Information</h3>
              <ul class="list-disc list-inside text-slate-600 space-y-1 ml-4">
        ...
        <div class="glass-card rounded-2xl p-8 border border-pink-200">
          ...
          <ul class="space-y-3">
            <li class="flex items-start">
              ...
              <span class="text-slate-600">Process and fulfill your orders</span>
            </li>
            <li class="flex items-start">
              <svg class="w-6 h-6 text-primary mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
              </svg>
              <span class="text-slate-600">Send order confirmations and shipping updates</span>
            </li>
            <li class="flex items-start">
              <svg class="w-6 h-6 text-primary mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
              </svg>
              <span class="text-slate-600">Provide customer support</span>
            </li>
            <li class="flex items-start">
              <svg class="w-6 h-6 text-primary mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
              </svg>
              <span class="text-slate-600">Send promotional emails (with your consent)</span>
            </li>
            <li class="flex items-start">
              <svg class="w-6 h-6 text-primary mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
              </svg>
              <span class="text-slate-600">Improve our website and services</span>
            </li>
            <li class="flex items-start">
              <svg class="w-6 h-6 text-primary mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
              </svg>
              <span class="text-slate-600">Prevent fraud and enhance security</span>
            </li>
          </ul>
        </div>
        ...
        <div class="glass-card rounded-2xl p-8 border border-pink-200 bg-gradient-to-br from-pink-50 to-purple-50">
          ...
          <div class="space-y-2 text-slate-600">
            <p><strong>Email:</strong> privacy@intimateelegance.com</p>
